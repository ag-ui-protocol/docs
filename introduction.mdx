...
<Info>
  This page focuses on the <strong>AG-UI protocol specification</strong>.  
  To see AG-UI in action—and to bring agents into applications—visit the  
  <a href="https://github.com/ag-ui-protocol/ag-ui" target="_blank"><strong>AG-UI GitHub repository</strong></a>.
</Info>
