...
description: "Use Cursor to build AWP implementations faster"
---

This guide will help you set up Cursor to help you build custom Agent Wire
Protocol (AWP) servers and clients faster. The same principles apply to other
IDE's like Windsurf, VSCode, etc.

## Adding the documentation to Cursor

1. Open up the Cursor settings
2. Go to Features > Docs and click "+ Add new Doc"
3. Paste in the following URL: https://docs.agentwire.io/llms-full.txt
4. Click "Add"
