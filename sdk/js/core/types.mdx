...
title: "Types"
description:
  "Documentation for the core types used in the Agent Wire Protocol SDK"
---

# Core Types

The Agent Wire Protocol SDK is built on a set of core types that represent the
fundamental structures used throughout the system. This page documents these
